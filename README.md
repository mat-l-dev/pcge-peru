...
El proyecto se encuentra en **etapa de desarrollo inicial** (`v0.2.1`). La API pública puede recibir ajustes y mejoras antes de alcanzar una versión de estabilidad definitiva.
