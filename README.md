...
- **Procedencia registrada**: Los metadatos de la fuente original, el hash SHA-256 del documento primario y el hash canónico del dataset se conservan en [`src/pcge/data/2026/source.json`](src/pcge/data/2026/source.json). El archivo fuente corresponde al documento oficial publicado por el MEF bajo la publicación 8559148 (`8559148-plan-contable-general-empresarial-pcge-2026(2).pdf`, SHA-256 `48C568CA196C68348743DDA96C55C38593B0437CE732A4C5D77D7C9ACA896B19`), cuyo texto del Capítulo II es idéntico al de las copias registradas bajo la norma 8559200.
